...
public class NoMovementOBEManager : MonoBehaviour
{
    ...
    [SerializeField] private Hand leftArmIK;
    [SerializeField] private Hand rightArmIK;
    [SerializeField] private Head headIK;
    [SerializeField] private RpmHandDriver rightHandDriver, leftHandDriver;
    [SerializeField] private XRHandTrackingEvents rightHandTracker, leftHandTracker;
    

    private OBEState state;
    private Camera OBECamera; 
    private float timeToOBE = 35f;
